...
#if defined(NDEBUG)
# error "Dracula cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Dracula Signed Message:\n";
...
static const int64_t nTargetTimespan = 25 * 60;  // 25 min
...
#ifdef ENABLE_WALLET
// Dracula: attempt to generate suitable proof-of-stake
